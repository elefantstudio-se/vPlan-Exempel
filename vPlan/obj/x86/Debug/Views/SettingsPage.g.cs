#pragma checksum "E:\OneDrive\ElefantStudio\Git\vPlan\vPlan\vPlan\vPlan\Views\SettingsPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "E6D81045D410E1874B2B2BC5FBCFF19C"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace vPlan.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        {
            private global::vPlan.Views.SettingsPage dataRoot;
            ...
            public void SetDataRoot(global::vPlan.Views.SettingsPage newDataRoot)
            {
                this.bindingsTracking.ReleaseAllListeners();
            ...
            private void Update_(global::vPlan.Views.SettingsPage obj, int phase)
            {
            ...
            private class SettingsPage_obj1_BindingsTracking
            {
                ...
                public void DependencyPropertyChanged_Frame(global::Windows.UI.Xaml.DependencyObject sender, global::Windows.UI.Xaml.DependencyProperty prop)
                {
                    ...
                    {
                        global::vPlan.Views.SettingsPage obj = sender as global::vPlan.Views.SettingsPage;
        if (obj != null)
        {
            bindings.Update_Frame(obj.Frame, DATA_CHANGED);
                ...
                public void UpdateChildListeners_(global::vPlan.Views.SettingsPage obj)
                {
                    SettingsPage_obj1_Bindings bindings;
                    if(WeakRefToBindingObj.TryGetTarget(out bindings))
                    {
                        ...
                        {
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::vPlan.Views.SettingsPage.FrameProperty, tokenDPC_Frame);
                        }
                        if (obj != null)
                        {
                            bindings.dataRoot = obj;
                            tokenDPC_Frame = obj.RegisterPropertyChangedCallback(global::vPlan.Views.SettingsPage.FrameProperty, DependencyPropertyChanged_Frame);
                        }
                    }
                }
            }
